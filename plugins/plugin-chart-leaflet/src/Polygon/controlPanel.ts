...
import {QueryMode, validateNonEmpty,} from '@superset-ui/core';
                ...
                [
                    {
                        ...
                        config: {
                            ...
                            description: 'Select whether to fix the color value or color by column values.',
                            renderTrigger: false,
                            default: fixedColor,
                        },
                    },
                ...
                [
                    {
                        ...
                        config: {
                            type: 'SliderControl',
                            label: 'Opacity',
                            description: 'Opacity of polygons. Between 0 and 1.',
                            default: 0.8,
                            step: 0.01,
                            min: 0,
                            max: 1,
    ...
    controlOverrides: {
        colorMetric: {
          ...
          description: '[optional] Metrics used to define tooltips and colors',
            renderTrigger: true, // Add renderTrigger here
        },
        groupby: {
            renderTrigger: true, // Add renderTrigger here too
        },
    },

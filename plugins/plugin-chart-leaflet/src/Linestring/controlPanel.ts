...
const color_dimension: typeof sharedControls.groupby = {
...
const color_metric: typeof sharedControls.metric = {
...
const tooltip_dimension: typeof sharedControls.groupby = {
    ...sharedControls.groupby,
...
const tooltip_metric: typeof sharedControls.metrics = {
        ...
        },
        {
            ...
            controlSetRows: [
                [
                    {
                        name: 'tooltipMetric',
                        config: tooltip_metric,
                    },
                ],
                [
                    {
                        name: 'tooltipDimension',
                        config: tooltip_dimension,
                    },
                ],
                [
                    {

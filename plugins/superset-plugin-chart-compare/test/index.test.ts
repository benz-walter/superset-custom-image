 ...
 * under the License.
 */
import { SupersetPluginChartCompare } from '../src';
 ...
 */
describe('superset-plugin-chart-compare', () => {
    let plugin = new SupersetPluginChartCompare().configure({
      key: 'ext-plugin-compare',
    })
  it('exists', () => {

...
import { SupersetPluginOccupancySpots } from 'superset-plugin-occupancy-spots';
import { SupersetPluginChartCompare } from 'superset-plugin-chart-compare';
import {
  LeafletPolygonPlugin,
  LeafletPointPlugin,
  LeafletLinestringPlugin,
  LeafletMultilayerPlugin,
} from 'superset-plugin-chart-leaflet';
import { IFramePlugin } from 'superset-plugin-chart-iframe';
import { LeafletWMSPlugin } from 'superset-plugin-leaflet-wms';
  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new SupersetPluginOccupancySpots().configure({
          key: 'superset-plugin-occupancy-spots',
        }),
        new SupersetPluginChartCompare().configure({
          key: 'superset-plugin-chart-compare',
        }),
        new LeafletPolygonPlugin().configure({
          key: 'leaflet_polygon',
        }),
        new LeafletPointPlugin().configure({
          key: 'leaflet_point',
        }),
        new LeafletLinestringPlugin().configure({
          key: 'leaflet_linestring',
        }),
        new LeafletMultilayerPlugin().configure({
          key: 'leaflet_multilayer',
        }),
        new IFramePlugin().configure({
          key: 'superset-plugin-chart-iframe',
        }),
        new LeafletWMSPlugin().configure({
          key: 'superset-plugin-leaflet-wms',
        }),
        ...experimentalPlugins,
      ],
    });

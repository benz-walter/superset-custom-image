...
class ExportSavedQueriesCommand(ExportModelsCommand):
    ...
    def _export(
        ...
        database_slug = model.database.database_name
        schema_slug = model.schema
        query_slug = model.label or model.uuid
        # currently a custom fix until fixed upstream with https://github.com/apache/superset/issues/26885

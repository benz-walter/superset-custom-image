...
export enum VizType {
  ...
  Chord = 'chord',
  Compare = 'compare',
  CompareTwoColumns = 'compare_two_columns',
  ...
  Horizon = 'horizon',
  IFrame = 'iframe',
  LeafletLinestring = 'leaflet_linestring',
  LeafletMultilayer = 'leaflet_multilayer',
  LeafletPoint = 'leaflet_point',
  LeafletPolygon = 'leaflet_polygon',

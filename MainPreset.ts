...
import IFrameChart from '../../../plugins/plugin-iframe/src/plugin';
import {
  LeafletPolygonPlugin,
  LeafletPointPlugin,
  LeafletLinestringPlugin,
  LeafletMultilayerPlugin,
} from '../../../plugins/plugin-chart-leaflet/src';
  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new LeafletWMSChart().configure({
          key: VizType.LeafletWMS,
        }),
        new SupersetPluginOccupancySpots().configure({
          key: VizType.OccupancySpots,
        }),
        new SupersetPluginChartCompare().configure({
          key: VizType.CompareTwoColumns,
        }),
        new IFrameChart().configure({
          key: VizType.IFrame,
        }),
        new LeafletPolygonPlugin().configure({
          key: VizType.LeafletPolygon,
        }),
        new LeafletPointPlugin().configure({
          key: VizType.LeafletPoint,
        }),
        new LeafletLinestringPlugin().configure({
          key: VizType.LeafletLinestring,
        }),
        new LeafletMultilayerPlugin().configure({
          key: VizType.LeafletMultilayer,
        }),
        ...experimentalPlugins,
        ...agGridTablePlugin,
      ],
